...
async function query_3(connection, reports, dateRange, db_name) {
    ...
    try {
        ...
        const [shard_rows] = await connection.query(`
            ...
            from ss_gfriend_master.ShardMap shard
        ...
        const [sns_rows] = await connection.query(`
            ...
            from ss_gfriend_master.SnsMap sns
...
async function main() {
    ...
    const account_1_query1_result = await query_1(connection, 'ss_gfriend_account_1', dateRange);
    const account_2_query1_result = await query_1(connection, 'ss_gfriend_account_2', dateRange);
    ...
    const account_1_query2_result = await query_2(connection, account_1_objectIDs, dateRange, 'ss_gfriend_account_1');
    const account_2_query2_result = await query_2(connection, account_2_objectIDs, dateRange, 'ss_gfriend_account_2');

    //TODO
    //count도 추가...
    //owner값도 추가...
    const account_1_query3_result = await query_3(connection, account_1_query2_result, dateRange, 'ss_gfriend_account_1');
    const account_2_query3_result = await query_3(connection, account_2_query2_result, dateRange, 'ss_gfriend_account_2');
